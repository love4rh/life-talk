...
public abstract class ApiHandler
{
	 ...
	 * @return
	 */
	public static boolean emptyCheck(Object ... args)
	{
		for(Object s : args)
		{
			if( s == null ) return true;
			if( s instanceof String && ((String) s).isEmpty() ) return true;
		}
	...
	/**
	 * 입력된 모든 파라미터가 null인지 여부 반환.
	 * 여러 파라미터 중 하나만 값이 있으면 되는 경우 등 체크할 때 사용
	 * @param args
	 * @return
	 */
	public static boolean emptyCheckAll(Object ... args)
	{
		for(Object s : args)
		{
			if( s != null ) return false;
			if( s instanceof String && !((String) s).isEmpty() ) return false;
		}
